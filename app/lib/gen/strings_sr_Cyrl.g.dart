...
class _TranslationsReceiveOptionsPageSrCyrl extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(iphone2win фолдер)';
  @override
...
class _TranslationsWebSharePageSrCyrl extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'iphone2win користи самопотписани сертификат. Морате га прихватити у свом прегледачу.';
  @override
...
class _TranslationsAboutPageSrCyrl extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'О iphone2win-у';
  @override
  List<String> get description => [
    'iphone2win је бесплатна апликација отвореног кода која вам омогућава да безбедно делите фајлове и поруке са уређајима у близини преко ваше локалне мреже, без потребе за интернет везом.',
...
class _TranslationsDonationPageSrCyrl extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'iphone2win је бесплатан, отвореног кода и без икаквих огласа. Ако вам се свиђа апликација, можете подржати развој донацијом.';
  @override
...
class _TranslationsTraySrCyrl extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Напусти iphone2win';
  @override
...
class _TranslationsNetworkInterfacesPageSrCyrl extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Подразумевано, iphone2win користи све доступне мрежне интерфејсе. Овде можете изузети нежељене мреже. Морате рестартовати сервер да би се примениле промене.';
}
...
class _TranslationsSettingsTabGeneralSrCyrl extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Прикажи iphone2win у контекстуалном менију';
  @override
...
class _TranslationsSettingsTabOtherSrCyrl extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Подржите iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedSrCyrl extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'iphone2win не може да пронађе друге уређаје без дозволе за скенирање локалне мреже. Дајте ову дозволу у подешавањима.';
  @override
...
class _TranslationsDialogsSendModeHelpSrCyrl extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Примаоци који немају инсталиран iphone2win могу преузети изабране фајлове отварањем линка у свом прегледачу.';
}
