...
class _TranslationsReceiveOptionsPagePtPt extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(pasta iphone2win)';
  @override
...
class _TranslationsWebSharePagePtPt extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'O iphone2win utiliza um certificado assinado automaticamente. Precisa de aceitá-lo no navegador.';
  @override
...
class _TranslationsAboutPagePtPt extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Acerca do iphone2win';
  @override
  List<String> get description => [
    'O iphone2win é uma aplicação gratuita e de código aberto que permite partilhar ficheiros e mensagens de forma segura com dispositivos próximos através da sua rede local, sem a necessidade de uma ligação à Internet.',
...
class _TranslationsDonationPagePtPt extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'O iphone2win é um software gratuito, de código aberto e sem qualquer anúncio. Se gosta da aplicação, considere apoiar o desenvolvimento com um donativo.';
  @override
...
class _TranslationsTrayPtPt extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Fechar o iphone2win';
  @override
...
class _TranslationsNetworkInterfacesPagePtPt extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Por padrão, o iphone2win utiliza todas as interfaces de rede disponíveis. Pode excluir as redes indesejadas aqui. É necessário reiniciar o servidor para aplicar as alterações.';
  @override
...
class _TranslationsSettingsTabGeneralPtPt extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Mostrar iphone2win no menu de contexto';
}
...
class _TranslationsSettingsTabOtherPtPt extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Suporte o iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedPtPt extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'O iphone2win não consegue encontrar outros dispositivos sem ter a permissão para analisar a rede local. Conceda esta permissão nas definições.';
  @override
...
class _TranslationsDialogsSendModeHelpPtPt extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Os destinatários que não têm o iphone2win instalado podem descarregar os ficheiros selecionados abrindo o link fornecido no navegador.';
}
