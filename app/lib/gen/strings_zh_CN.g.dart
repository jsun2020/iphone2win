...
class _TranslationsReceiveOptionsPageZhCn extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(iphone2win 文件夹)';
  @override
...
class _TranslationsWebSharePageZhCn extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'iphone2win 使用自签名证书。您需要在浏览器中允许它。';
  @override
...
class _TranslationsAboutPageZhCn extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => '关于 iphone2win';
  @override
  List<String> get description => [
    'iphone2win 是一款免费的开源应用程序，可让您通过本地网络与附近的设备安全地分享文件和信息，而无需互联网连接。',
...
class _TranslationsDonationPageZhCn extends TranslationsDonationPageEn {
  ...
  String get title => '捐赠';
  @override
  String get info => 'iphone2win 免费、开源、无广告。如果您喜欢这款应用程序，可以捐款支持开发。';
  @override
...
class _TranslationsNetworkInterfacesPageZhCn extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info => '默认情况下，iphone2win 使用所有可用的网络接口。您可以在此处排除不需要的网络接口。您需要重新启动服务器以应用更改。';
  @override
  String get preview => '预览';
  @override
...
class _TranslationsSettingsTabGeneralZhCn extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => '在“发送到...”文件菜单中显示 iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedZhCn extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'iphone2win 在没有扫描本地网络的权限的情况下无法找到其他设备。请在设置中授予此权限。';
  @override
...
class _TranslationsDialogsSendModeHelpZhCn extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => '未安装 iphone2win 的接收者可以在浏览器中打开链接以下载选中的文件。';
}
