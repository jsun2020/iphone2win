...
class _TranslationsReceiveOptionsPageAr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(مجلد iphone2win)';
  @override
...
class _TranslationsWebSharePageAr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'يستخدم تطبيق iphone2win شهادة موقع ذاتية التوقيع. يجب عليك قبولها في المتصفح.';
  @override
...
class _TranslationsAboutPageAr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'عن iphone2win';
  @override
  List<String> get description => [
    'iphone2win هو تطبيق مجاني مفتوح المصدر يسمح لك بمشاركة الملفات والرسائل بشكل آمن مع الأجهزة القريبة عبر شبكتك المحلية دون الحاجة إلى اتصال بالإنترنت.',
...
class _TranslationsDonationPageAr extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'iphone2win مجاني ومفتوح المصدر وبدون أي إعلانات. إذا أعجبك التطبيق، يمكنك دعم التطوير بالتبرع.';
  @override
...
class _TranslationsTrayAr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'أنهِ iphone2win';
  @override
...
class _TranslationsNetworkInterfacesPageAr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'بشكل افتراضي، يستخدم iphone2win جميع واجهات الشبكة المتاحة. يمكنك استبعاد الشبكات غير المرغوب فيها هنا. تحتاج إلى إعادة تشغيل الخادم لتطبيق التغييرات.';
  @override
  String get preview => 'معاينة';
}
...
class _TranslationsSettingsTabGeneralAr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'إظهار iphone2win في قائمة السياق';
  @override
...
class _TranslationsSettingsTabOtherAr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'دعم iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedAr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'لا يمكن ل iphone2win العثور على الأجهزة الأخرى بدون الإذن بفحص الشبكة المحلية. يُرجى منح هذا الإذن في الإعدادات.';
  @override
...
class _TranslationsDialogsSendModeHelpAr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'يمكن للمستلمين الذين لا يحتوون على iphone2win تنزيل الملفات المحددة عن طريق فتح الرابط في متصفحهم.';
}
