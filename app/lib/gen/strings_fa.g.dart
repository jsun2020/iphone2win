...
class _TranslationsNetworkInterfacesPageFa extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'به طور پیش فرض، iphone2win از تمام رابط های شبکه موجود استفاده می کند. در اینجا می توانید شبکه های ناخواسته را حذف کنید. برای اعمال تغییرات باید سرور را ریستارت کنید.';
  @override
