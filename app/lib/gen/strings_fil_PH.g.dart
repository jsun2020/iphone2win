...
class _TranslationsNetworkInterfacesPageFilPh extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Bilang default, ang iphone2win ay gumagamit ng lahat ng mga available na network interface. Maaari mong ibukod ang mga hindi mo gustong network dito. Kinakailangang i-restart ang server upang mai-apply ang mga pagbabago';
  @override
...
class _TranslationsWebSharePageFilPh extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'Ang iphone2win ay gumagamit ng self-signed certificate. Kailangan mo itong i-accept sa browser.';
  @override
...
class _TranslationsAboutPageFilPh extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Tungkol sa iphone2win';
  @override
  List<String> get description => [
    'Ang iphone2win ay isang libre at open-source na app na nagbibigay-daan sa secure na pagbabahagi ng mga file at mga message sa mga kalapit na device sa iyong local network nang hindi nangangailangan ng koneksyon sa internet.',
...
class _TranslationsDonationPageFilPh extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'Ang iphone2win ay libre, open-source, at walang anumang mga ad. Kung iyong nagustuhan ang app, maaari mong suportahan ang development sa pamamagitan ng donasyon.';
  @override
...
class _TranslationsTrayFilPh extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Isara ang iphone2win';
  @override
...
class _TranslationsSettingsTabGeneralFilPh extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Ipakita ang iphone2win sa context menu';
  @override
...
class _TranslationsSettingsTabOtherFilPh extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Suportahan ang iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedFilPh extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'Hindi makikita ng iphone2win ang ibang devices hangga\'t hindi nabibigyan ng permission para mag-scan sa lokal na network. Mangyaring bigyan ito ng permission sa settings.';
  @override
...
class _TranslationsDialogsSendModeHelpFilPh extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Ang mga recipient o tatanggap na walang nakainstall na iphone2win ay maaaring mag download nang mga napiling file sa pamamagitan ng pagbukas ng link sa kanilang browser.';
}
