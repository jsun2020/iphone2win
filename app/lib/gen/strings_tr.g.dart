...
class _TranslationsReceiveOptionsPageTr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(iphone2win klasörü)';
  @override
...
class _TranslationsWebSharePageTr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'iphone2win, tarayıcıda kabul etmeniz gereken kendi-üretimli bir sertifika kullanır.';
  @override
...
class _TranslationsAboutPageTr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'iphone2win hakkında';
  @override
  List<String> get description => [
    'iphone2win, internet bağlantısına ihtiyaç duymadan yerel ağınız üzerinden yakınınızdaki cihazlarla dosya ve mesajlarınızı güvenli bir şekilde paylaşmanıza olanak tanıyan özgür ve açık kaynaklı bir uygulamadır.',
...
class _TranslationsDonationPageTr extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'iphone2win ücretsiz, açık kaynaklı ve reklamsız bir uygulamadır. Eğer uygulamayı beğendiyseniz, bağış yaparak uygulamanın gelişimine katkıda bulunabilirsiniz.';
  @override
...
class _TranslationsTrayTr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'iphone2win\'den çık';
  @override
...
class _TranslationsNetworkInterfacesPageTr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Varsayılan olarak, iphone2win mevcut olan tüm ağları kullanır. Burada istenmeyen ağları engelleyebilirsiniz. Değişikliklerin uygulanması için sunucuyu yeniden başlatmanız gerekir.';
}
...
class _TranslationsSettingsTabGeneralTr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'iphone2win\'i bağlam menüsünde göster';
  @override
...
class _TranslationsSettingsTabOtherTr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'iphone2win\'i destekle';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedTr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'iphone2win, lokal ağı tarama iznine sahip olmadan başka cihazları bulamıyor. Lütfen bu izni ayarlarda verin.';
  @override
...
class _TranslationsDialogsSendModeHelpTr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'iphone2win yüklü olmayan alıcılar, tarayıcılarındaki bağlantıyı açarak seçilen dosyaları indirebilir.';
}
