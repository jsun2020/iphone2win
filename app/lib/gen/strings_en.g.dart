...
class TranslationsNetworkInterfacesPageEn {
  ...
  /// en: 'By default, iphone2win uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, iphone2win uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class TranslationsReceiveOptionsPageEn {
  ...
  /// en: '(iphone2win folder)'
  String get appDirectory => '(iphone2win folder)';
...
class TranslationsWebSharePageEn {
  ...
  /// en: 'iphone2win uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'iphone2win uses a self-signed certificate. You need to accept it in your browser.';
...
class TranslationsAboutPageEn {
  ...
  /// en: 'About iphone2win'
  String get title => 'About iphone2win';

  List<String> get description => [
    'iphone2win is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class TranslationsDonationPageEn {
  ...
  /// en: 'iphone2win is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'iphone2win is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class TranslationsTrayEn {
  ...
  /// en: 'Quit iphone2win'
  String get close => 'Quit iphone2win';
...
class TranslationsSettingsTabGeneralEn {
  ...
  /// en: 'Show iphone2win in context menu'
  String get showInContextMenu => 'Show iphone2win in context menu';
...
class TranslationsSettingsTabOtherEn {
  ...
  /// en: 'Support iphone2win'
  String get support => 'Support iphone2win';
...
class TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  /// en: 'iphone2win can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'iphone2win can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class TranslationsDialogsSendModeHelpEn {
  ...
  /// en: 'Recipients who do not have iphone2win installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have iphone2win installed can download the selected files by opening the link in their browser.';
}
