...
class _TranslationsReceiveOptionsPageJa extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(iphone2win フォルダー)';
  @override
...
class _TranslationsWebSharePageJa extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'iphone2winは自己署名証明書を使用しているため、ブラウザーで証明書を許可する必要があります。';
  @override
...
class _TranslationsAboutPageJa extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'iphone2winについて';
  @override
  List<String> get description => [
    'iphone2winは無料のオープンソースアプリで、インターネットに接続することなく、ローカルネットワーク経由で近くにあるデバイスとファイルやメッセージを安全に共有することができます。',
...
class _TranslationsDonationPageJa extends TranslationsDonationPageEn {
  ...
  String get title => '寄付';
  @override
  String get info => 'iphone2winは無料かつオープンソースで、広告を一切含みません。もしアプリを気に入っていただけたら、寄付で開発を支援することができます。';
  @override
...
class _TranslationsTrayJa extends TranslationsTrayEn {
  ...
  @override
  String get close => 'iphone2winを終了';
  @override
...
class _TranslationsNetworkInterfacesPageJa extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info => 'デフォルトでは、iphone2win は利用可能なすべてのネットワークインターフェースを使用します。不要なネットワークを除外するには、ここで設定できます。変更を適用するには、サーバーを再起動する必要があります。';
}
...
class _TranslationsSettingsTabGeneralJa extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'コンテキストメニューにiphone2winを表示';
  @override
...
class _TranslationsSettingsTabOtherJa extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'iphone2winを支援';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedJa extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'ローカルネットワークをスキャンする権限がないと、iphone2winは他のデバイスを見つけることができません。設定よりこの権限を付与してください。';
  @override
...
class _TranslationsDialogsSendModeHelpJa extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'iphone2winをインストールしていない受信者でも、ブラウザでリンクを開くことで選択したファイルをダウンロードできます。';
}
