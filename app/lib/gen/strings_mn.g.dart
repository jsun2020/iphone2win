...
class _TranslationsReceiveOptionsPageMn extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(iphone2win-н хавтас)';
  @override
...
class _TranslationsWebSharePageMn extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'iphone2win нь өөрийн гарын үсэг ашигладаг тул үүнийг browser дээрээ хүлээн зөвшөөрнө үү.';
  @override
...
class _TranslationsAboutPageMn extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'iphone2win танилцуулга';
  @override
  List<String> get description => [
    'iphone2win нь үнэгүй, нээлттэй эхийн програм бөгөөд танд интернет холболт шаардлагагүйгээр өөрийн дотоод сүлжээгээр ойролцоох төхөөрөмжүүдтэй файл, мессежийг аюулгүйгээр хуваалцах боломтой.',
...
class _TranslationsDonationPageMn extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'iphone2win нь үнэ төлбөргүй, нээлттэй эх сурвалжтай бөгөөд ямар ч зар сурталчилгаагүй. Хэрэв энэ програм таалагдсан бол хандивын мөнгөөр хөгжлийг дэмжих боломжтой.';
  @override
...
class _TranslationsSettingsTabGeneralMn extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Системийн цэсэнд iphone2win-д харуулах';
  @override
...
class _TranslationsSettingsTabOtherMn extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'iphone2win-г дэмжих';
  @override
