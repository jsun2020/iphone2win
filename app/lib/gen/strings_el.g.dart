...
class _TranslationsReceiveOptionsPageEl extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(Φάκελος iphone2win)';
  @override
...
class _TranslationsWebSharePageEl extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'Το iphone2win χρησιμοποιεί αυτο-υπογεγραμμένο πιστοποιητικό. Χρειάζεται να το αποθεχτείτε στον φυλλομετρητή.';
  @override
...
class _TranslationsAboutPageEl extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Σχετικά με το iphone2win';
  @override
  List<String> get description => [
    'Το iphone2win είναι μια δωρεάν εφαρμογή ανοιχτού κώδικα που σας επιτρέπει να μοιράζεστε με ασφάλεια αρχεία και μηνύματα με κοντινές συσκευές μέσω του τοπικού σας δικτύου χωρίς να χρειάζεστε σύνδεση στο διαδίκτυο.',
...
class _TranslationsDonationPageEl extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'Το iphone2win είναι δωρεάν, ανοιχτού κώδικα και χωρίς διαφημίσεις. Εάν σας αρέσει η εφαρμογή, μπορείτε να υποστηρίξετε την ανάπτυξή της με μια δωρεά.';
  @override
...
class _TranslationsTrayEl extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Έξοδος από το iphone2win';
  @override
...
class _TranslationsNetworkInterfacesPageEl extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Από προεπιλογή, το iphone2win χρησιμοποιεί όλες τις διαθέσιμες διεπαφές δικτύου. Μπορείτε να εξαιρέσετε τα ανεπιθύμητα δίκτυα εδώ. Πρέπει να κάνετε επανεκκίνηση του διακομιστή για να εφαρμόσετε τις αλλαγές.';
  @override
...
class _TranslationsSettingsTabGeneralEl extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Προβολή του iphone2win στο μενού του περιβάλλοντος εργασίας';
  @override
...
class _TranslationsSettingsTabOtherEl extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Υποστηρίξτε το iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedEl extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'Το iphone2win δεν μπορεί να βρει άλλες συσκευές χωρίς την άδεια σάρωσης του τοπικού δικτύου. Παρακαλείστε να παραχωρήσετε αυτό το δικαίωμα στις ρυθμίσεις.';
  @override
...
class _TranslationsDialogsSendModeHelpEl extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Οι παραλήπτες που δεν έχουν εγκαταστήσει το iphone2win μπορούν να πραγματοποιήσουν λήψη των επιλεγμένων αρχείων ανοίγοντας τον σύνδεσμο στον φυλλομετρητή τους.';
}
