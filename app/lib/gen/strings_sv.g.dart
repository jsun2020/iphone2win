...
class _TranslationsReceiveOptionsPageSv extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(iphone2win-mappen)';
  @override
...
class _TranslationsWebSharePageSv extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'iphone2win använder ett självsignerat certifikat. Du behöver acceptera det i webbläsaren.';
  @override
...
class _TranslationsAboutPageSv extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Om iphone2win';
  @override
  List<String> get description => [
    'iphone2win är fri programvara med öppen källkod som låter dig säkert dela filer och meddelanden med enheter i närheten över ditt lokala nätverk utan att behöva en internetanslutning.',
...
class _TranslationsDonationPageSv extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'iphone2win är fri programvara med öppen källkod och utan några annonser. Om du gillar appen kan du stödja utvecklingen med en donation.';
  @override
...
class _TranslationsTraySv extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Avsluta iphone2win';
  @override
...
class _TranslationsNetworkInterfacesPageSv extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Som standard använder iphone2win alla tillgängliga nätverksgränssnitt. Du kan utesluta oönskade nätverk här. Du måste starta om servern för att tillämpa ändringarna.';
  @override
  String get preview => 'Förhandsvisning';
  @override
...
class _TranslationsSettingsTabGeneralSv extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Visa iphone2win i snabbmenyn';
  @override
...
class _TranslationsSettingsTabOtherSv extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Stöd iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedSv extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'iphone2win kan inte hitta andra enheter utan att ha behörighet att skanna det lokala nätverket. Bevilja denna behörighet i inställningarna.';
  @override
...
class _TranslationsDialogsSendModeHelpSv extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Mottagare som inte har iphone2win installerat kan ladda ner de valda filerna genom att öppna länken i deras webbläsare.';
}
