...
class _TranslationsReceiveOptionsPagePtBr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(pasta do iphone2win)';
  @override
...
class _TranslationsWebSharePagePtBr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'O iphone2win utiliza um certificado autoassinado. Você precisa aceitá-lo no seu navegador.';
  @override
...
class _TranslationsAboutPagePtBr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Sobre o iphone2win';
  @override
  List<String> get description => [
    'O iphone2win é um aplicativo gratuito, de código aberto, que permite compartilhar arquivos e mensagens com dispositivos próximos através da sua rede local, sem a necessidade de uma conexão à internet.',
...
class _TranslationsDonationPagePtBr extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'O iphone2win é gratuito, de código aberto e não tem anúncios. Se tu curte o app, então pense em apoiar o desenvolvimento com uma doação.';
  @override
...
class _TranslationsTrayPtBr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Sair do iphone2win';
  @override
...
class _TranslationsNetworkInterfacesPagePtBr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Por padrão, o iphone2win utiliza todas as interfaces de rede disponíveis. Você pode excluir as redes indesejadas aqui. É necessário reiniciar o servidor para aplicar as alterações.';
  @override
  String get preview => 'Pré-visualização';
  @override
...
class _TranslationsSettingsTabOtherPtBr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Apoiar o iphone2win';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedPtBr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'O iphone2win não consegue encontrar outros dispositivos sem ter a permissão para escanear a rede local. Conceda esta permissão nas configurações.';
  @override
...
class _TranslationsDialogsSendModeHelpPtBr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Os destinatários que não têm o iphone2win instalado podem baixar os arquivos selecionados abrindo o link fornecido no navegador.';
}
