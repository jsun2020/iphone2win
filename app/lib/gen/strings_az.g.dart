...
class _TranslationsWebSharePageAz extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'iphone2win özü imzalanmış sertifikatdan istifadə edir. Siz onu brauzerinizdə qəbul etməlisiniz.';
}
...
class _TranslationsNetworkInterfacesPageAz extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Defolt olaraq, iphone2win bütün mövcud şəbəkə interfeyslərindən istifadə edir. Burada istənilməyən şəbəkələri istisna edə bilərsiniz. Dəyişiklikləri tətbiq etmək üçün serveri yenidən başlatmalısınız.';
  @override
...
class _TranslationsTrayAz extends TranslationsTrayEn {
  ...
  @override
  String get close => 'iphone2win-dən çıx';
}
...
class _TranslationsReceiveOptionsPageAz extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(iphone2win qovluğu)';
  @override
...
class _TranslationsDonationPageAz extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'iphone2win pulsuz, açıq mənbəlidir və heç bir reklam yoxdur. Proqramı bəyənirsinizsə, ianə ilə inkişafını dəstəkləyə bilərsiniz.';
  @override
...
class _TranslationsAboutPageAz extends TranslationsAboutPageEn {
  ...
  List<String> get description => [
    'iphone2win internet bağlantısına ehtiyac olmadan lokal şəbəkə üzərindən yaxınlıqdakı cihazlarla faylları və mesajları təhlükəsiz paylaşmağa imkan verən pulsuz, açıq mənbəli proqramdır.',
  ...
  @override
  String get title => 'iphone2win haqqında';
  @override
...
class _TranslationsSettingsTabGeneralAz extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Məzmun menyusunda iphone2win-i göstər';
  @override
...
class _TranslationsSettingsTabOtherAz extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'iphone2win-i dəstəklə';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedAz extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'iphone2win lokal şəbəkəni skan etmək icazəsi olmadan digər cihazları tapa bilmir. Zəhmət olmasa, parametrlərdən bu icazəni verin.';
  @override
...
class _TranslationsDialogsSendModeHelpAz extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'iphone2win-i quraşdırmamış alıcılar linki brauzerlərində açaraq seçilmiş faylları endirə bilərlər.';
}
